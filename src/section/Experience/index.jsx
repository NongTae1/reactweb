...
import picExp from '../../assets/guitar.jpg'
import picExp1 from '../../assets/aemeath.jpg'
...
const Experience = () => {
    ...
    return (
        <div className="">
            ...
            <div className={`grid grid-cols-[25%_75%]  rounded px-2 py-6 transition-all ${isMouseEnter ['exp1']? "bg-green-300" : ""}`}
